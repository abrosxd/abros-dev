  ...
  fetch("main/yaml/about.yaml")
    ...
    .then((yamlData) => {
      ...
      const changeabout = (language) => {
        ...
        document.querySelector(".ttime").textContent =
          data.time.title[language];
        ...
        document.querySelector(".treviews").textContent =
          data.reviews[language];
        document.querySelector(".tfaq").textContent = data.faq[language];
        document.querySelector(".tgallery").textContent =
          data.gallery[language];
        ...
        document.querySelector(".tsoft").textContent =
          data.tools.soft[language];
