export function initPortfolioPage() {
  ...
  fetch("main/yaml/portfolio.yaml")
    ...
    .catch((error) =>
      console.error("Ошибка загрузки файла portfolio.yaml", error)
    );
  ...
  const handleActiveChange = () => {
    filterArrow.style.transform = `rotate(${
      filterSubMenu.classList.contains("active") ? "180" : "0"
    }deg)`;
  };
